...
namespace labutils
{
	...
	Image create_intermediate_image_texture2d(Allocator const& aAllocator, std::uint32_t, std::uint32_t, VkFormat, VkImageUsageFlags = VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT);
